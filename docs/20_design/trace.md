...
| REQ-NFR-01 | P1 | D2/D4 | MEAS（criterion、CI でしきい値） | 06_numeric_model.md, DD-D2-diffuse.md, README.md | — |
| REQ-NFR-02 | P1 | D12 | MEAS（実機） | 03_domain_model.md, 05_contract.md, 10_persistence.md, DD-D2-diffuse.md | — |
