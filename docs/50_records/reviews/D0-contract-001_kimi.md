...
- 対象: commit 44e1bb4（docs/30_contracts/simulation_contract.md v0.1、docs/30_contracts/schema/*.json、crates/sim-types/src/lib.rs）
- 正本: docs/00_product/第2回_統合案_v0.5.md 1.1〜1.3, 1.6, 7.1〜7.3
